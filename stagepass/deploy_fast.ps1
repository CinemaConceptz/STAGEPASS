...
gcloud run deploy stagepass-web `
  ...
  --memory 1Gi `
  --cpu 1 `
  --set-env-vars "NEXT_PUBLIC_FIREBASE_API_KEY=$FIREBASE_API_KEY,NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN=$FIREBASE_AUTH_DOMAIN,NEXT_PUBLIC_FIREBASE_PROJECT_ID=$FIREBASE_PROJECT_ID,NEXT_PUBLIC_FIREBASE_STORAGE_BUCKET=$FIREBASE_STORAGE_BUCKET,NEXT_PUBLIC_FIREBASE_MESSAGING_SENDER_ID=$FIREBASE_MESSAGING_SENDER_ID,NEXT_PUBLIC_FIREBASE_APP_ID=$FIREBASE_APP_ID,NEXT_PUBLIC_GOOGLE_API_KEY=$GOOGLE_API_KEY,NEXT_PUBLIC_GOOGLE_CLIENT_ID=$GOOGLE_CLIENT_ID,NEXT_PUBLIC_API_URL=$ApiUrl,WORKER_SERVICE_URL=$WorkerUrl,GOOGLE_API_KEY=$GOOGLE_API_KEY,GCS_BUCKET=$FIREBASE_STORAGE_BUCKET,FIREBASE_PROJECT_ID=$FIREBASE_PROJECT_ID,PUBSUB_TOPIC=stagepass-content-process,FIREBASE_CLIENT_EMAIL=$FIREBASE_CLIENT_EMAIL" `
