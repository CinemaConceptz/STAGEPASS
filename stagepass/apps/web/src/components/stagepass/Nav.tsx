    ...
    <header className="sticky top-0 z-40 w-full border-b border-white/10 bg-stage-bg/80 backdrop-blur-md">
      <div className="mx-auto flex w-full max-w-7xl items-center justify-between px-4 h-16">
        ...
        <nav className="hidden md:flex items-center gap-2">
          ...
          {/* Only show Studio link in nav if logged in, or keep it public? Usually public nav is cleaner without it unless logged in */}
        ...
        <div className="flex items-center gap-3">
          {loading ? (
            ...
            <div className="flex items-center gap-4">
              ...
              <Link
                href="/studio"
                className="hidden md:block rounded-xl bg-stage-indigo px-4 py-2 text-sm font-bold text-white shadow-glowIndigo hover:bg-stage-indigo/90"
              >
                Dashboard
              </Link>
            </div>
